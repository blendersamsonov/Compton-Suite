...
principle above -- see ``compton_suite.misc.get_xp``/``.to_host``).
...
from compton_suite.io.units import HBAR_Q, LIGHT_TIME_CONTEXT, M_TO_CM
from compton_suite.misc import get_xp, to_host
from compton_suite.models.api import Job
...
class DirectAdapter:
    ...
    def run(self, job: Job) -> Photons:
        ...
        (``compton_suite.io.bunch.sample_gaussian_bunch``), not one per
        model."""
