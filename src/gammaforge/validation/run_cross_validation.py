...
from gammaforge.validation import tier0_wiring, tier1_yield, tier2_spectrum, tier3_angular_shape, tier4_regime_boundary
from gammaforge.validation.scenarios import BASELINE, LOW_A0
from gammaforge.validation.runners import run_analytical, run_kascade, run_xigma, run_delta
...
def run() -> bool:
    print("############################################")
    print("# GammaForge cross-model validation suite #")
    print("############################################")
    print()
