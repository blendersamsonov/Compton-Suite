"""Physics engine models for GammaForge.

Each model implements the ``ModelAdapter`` protocol (``gammaforge.models.api``)
...
dependency breaking `import gammaforge.models` entirely.
"""
