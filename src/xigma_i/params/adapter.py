"""Canonical params -> this model's own convention/units.
...
unit and convention ``gui_adapter.Config``/``set_*_parameters`` expects, so
model code itself performs no conversion.
"""
