...
event-generator Monte Carlo) and **xigma-i** (`compton_suite.models.xigma_i.core.Compton`, a
...
| Files | `compton_suite/models/kascade/kascade.py` (`run_multiphoton_chain`, `run_simulation`, `Results`) | `compton_suite/models/xigma_i/gui_adapter.py` (`run_simulation`) |
...
| Files | `compton_suite/models/kascade/kascade.py` | `compton_suite/models/xigma_i/core.py` (`particle_kernel`, `calculate_intersection`), `compton_suite/models/xigma_i/gui_adapter.py` (wiring) |
| Risk | Low (additive) | Was flagged higher-risk (new CUDA kernel code); implemented and validated against real GPU hardware via `scripts/headless_test.py` (includes a normalization sanity check) |
...
| Files | `compton_suite/gui/app.py` (`_render_angular_distribution`) only | `compton_suite/gui/app.py` (`_render_angular_distribution`) only |
...
| Files | `compton_suite/models/kascade/kascade_adapter.py` | `compton_suite/models/xigma_i/gui_adapter.py` (`_theta_grid`, `spectrum_in_angular_range`) |
