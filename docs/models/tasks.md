...
- [ ] Make sure to properly use streaming capabilities when ran from gui. Get VRAM amount and make sure that the program never allocates gpu arrays larger than, say 70%, of full amount
