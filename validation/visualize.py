...
from tier1_yield import _total_yield_kascade  # noqa: E402
from tier2_spectrum import compton_edge_eV, to_dNdE_on_grid  # noqa: E402
from tier3_angular_shape import collimated_fraction  # noqa: E402
...
def plot_angular_shape_comparison(scenario: Scenario, results: dict, out_path: Path) -> None:
    ...
    from xigma_i.gui_adapter import spectrum_in_angular_range as xigma_sar
    from xigma_direct.gui_adapter import spectrum_in_angular_range as xdirect_sar
