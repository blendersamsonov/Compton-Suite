...
from compton_io.bunch import GaussianElectronBeam, fit_gaussian, sample_gaussian_bunch  # noqa: E402
from compton_io.io_formats.sdds import load_elegant_ele, save_elegant_ele  # noqa: E402
from compton_io.io_formats.yaml_spec import (  # noqa: E402
    load_electron_beam,
    load_laser,
    save_electron_beam,
    save_laser,
...
def test_spec_example_electron_beam_yaml_round_trips():
    spec_path = (
        Path(__file__).resolve().parent.parent / "specs" / "electron_beam_io_v0.1_full.md"
    )
    example_yaml = """
electron_beam:
